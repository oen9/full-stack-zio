      ...
      div(className := "modal-dialog modal-dialog-centered", role := "document",
        div(className := "modal-content",
          ...
          div(className := "modal-footer",
            button(`type` := "button", className := "btn btn-secondary", data-"dismiss" := "modal", onClick := props.onCancel, "cancel"),
            button(`type` := "button", className := "btn btn-danger", data-"dismiss" := "modal", "delete", onClick := props.onDelete),
          )
        )
      )
    )
